...
var e, a, s, c, r, t, i, n, E, k, d, l, o, S, p, _, b, u, T, f, N, x, L, R = {
    BOOLEAN: "Boolean",
        ...
        e: for (;!t.isBreakLoop; ) if (t.idx++, n = c(t, 0), "%><%" === t.ENV) switch (n) {
          ...
          case "/":
            switch (d = c(t, 1)) {
              ...
              default:
                "<" === t.ENV[1] && ">" === d ? (t.deep--, i(t, null), k(t, 1, "/" !== t.ENV[2] ? R.JSX_TAG_OPENER_END_CHILDLESS : R.JSX_TAG_CLOSER_END)) : e(t.tokenLast) ? b(t) : k(t, "=" === d ? 1 : 0);
            }
            break;
...
exports.CHILDLESS_TAGS = O, exports.TOKEN_TYPES = R, exports.jsx2tokens = g;
