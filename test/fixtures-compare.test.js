...
//       test(`FIXTURES-COMPARE (${dir}): ${file}`, () => {
//         const code = fs.readFileSync(full, 'utf8')
//         expect(jsx2tokensTokenize(code)).toEqual(typescriptTokenize(code))
//       })
//     }
//   })
// }
...
const code = fs.readFileSync(path.resolve(DIR_FIXTURES, 'angular/angular.js'), 'utf8')
